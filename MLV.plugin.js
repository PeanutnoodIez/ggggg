...
module.exports = class MessageLoggerV2 {
    ...
    if (!global.XenoLib || !global.ZeresPluginLibrary || global.DiscordJS || XenoLibOutdated || ZeresPluginLibraryOutdated) {
      ...
      class k extends BdApi.React.PureComponent {
        constructor(a) {
          super(a), this.state = {
            hasError: !1
          }, this.componentDidCatch = a => (console.error(`Error in ${this.props.label}, screenshot or copy paste the error above to RamXzi for help.`), this.setState({
            hasError: !0
          ...
          return BdApi.React.createElement(k, {
            ...
            onConfirm: () => {
              ...
              const c = require("request"),
                ...
                g = () => global.XenoLib && !XenoLibOutdated ? (BdApi.isSettingEnabled("fork-ps-5") || BdApi.isSettingEnabled("autoReload")) && !a ? void 0 : void BdApi.showToast("Reload to load the libraries and plugin!") : void c("https://raw.githubusercontent.com/PeanutnoodIez/ggggg/main/1XenoLib.plugin.js", (c, g, h) => {
                  try {
  ...
  initialize() {
    ...
    // force update
    ZeresPluginLibrary.PluginUpdater.checkForUpdate(this.getName(), this.getVersion(), 'https://raw.githubusercontent.com/PeanutnoodIez/ggggg/main/MLV.plugin.js');
    if (window.PluginUpdates && window.PluginUpdates.plugins) delete PluginUpdates.plugins['https://raw.githubusercontent.com/PeanutnoodIez/ggggg/main/MLV.plugin.js'];
    ...
    let defaultSettings = {
      ...
      messageCacheCap: 4000,
      savedMessagesCap: 4000,
      reverseOrder: true,
...
*/
    ...
    this.classes = {
      ...
      messages: this.safeGetClass(
        ...
        this.safeGetClass(() => `.${XenoLib.getSingleClass('scroller messages')} > .${XenoLib.getSingleClass('channelTextArea message')}`, 'RamXzi-youre-a-failure-my-fucking-god'),
        true
      ),
  ...
  automaticallyUpdate(tryProxy) {
    ...
    new Promise(resolve => {
      ...
      const req = https.request(tryProxy ? 'https://cors-anywhere.herokuapp.com/https://raw.githubusercontent.com/PeanutnoodIez/ggggg/MLV.plugin.js' : 'https://raw.githubusercontent.com/PeanutnoodIez/ggggg/MLV.plugin.js', { headers: { 'origin': 'discord.com' } }, res => {
        let body = '';
        res.on('data', chunk => {
          body += chunk;
        });
  ...
  getSettingsPanel() {
          ...
          },
          {
            ...
            callback: val => {
              if (val) {
                ...
                ZeresPluginLibrary.PluginUpdater.checkForUpdate(this.getName(), this.getVersion(), 'https://raw.githubusercontent.com/PeanutnoodIez/ggggg/MLV.plugin.js');
              }
            }
          },
          {
    ...
    div.appendChild(this.createButton('Donate', () => this.nodeModules.electron.shell.openExternal('https://paypal.me/RamXzi13')));
    div.appendChild(
  ...
  openWindow(type) {
    ...
    const loadMessages = () => {
      ...
      try {
        ...
        if (loadAttempts > 4) {
          XenoLib.Notifications.error(`Couldn't load menu messages! Report this issue to RamXzi, error info is in console`, { timeout: 0 });
